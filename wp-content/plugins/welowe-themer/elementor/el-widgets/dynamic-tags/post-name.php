...
class GVAElement_Post_Name extends GVAElement_Base{
	...
	public function get_title(){
		return esc_html__('Post Title', 'welowe-themer');
	}
	...
	protected function register_controls(){
		$this->start_controls_section(
			self::NAME,
			[
				'label' => esc_html__('General', 'welowe-themer'),
		...
		$this->add_control(
			'html_tag',
			[
				'label' => esc_html__('Tag', 'welowe-themer'),
				'type' => Controls_Manager::SELECT,
				'options' => [
				  	'div' => esc_html__('DIV', 'welowe-themer'),
				  	'h1' => esc_html__('H1', 'welowe-themer'),
				  	'h2' => esc_html__('H2', 'welowe-themer'),
				  	'h3' => esc_html__('H3', 'welowe-themer'),
				  	'h4' => esc_html__('H4', 'welowe-themer'),
				  	'h5' => esc_html__('H5', 'welowe-themer'),
				],
				'default' => 'h1',
			]
		);
