...
class GVAElement_Career_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Career Block', 'welowe-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Categories', 'welowe-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			'job_content',
			[
				'label' => __( 'Job Type', 'welowe-themer' ),
		...
		$this->add_control(
			'company',
			[
				'label' => __( 'Company', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'address',
			[
				'label' => __( 'Address', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'welowe-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
