...
class GVAElement_Content_Carousel extends GVAElement_Base{
   ...
   public function get_title() {
      return __('Content Carousel', 'welowe-themer');
   }
   ...
   public function get_style_depends() {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
          'shadow_sub_title',
          [
            'label'       => __('Shadow Sub Title', 'welowe-themer'),
        ...
        $repeater->add_control(
          'sub_title',
          [
            'label'       => __('SubTitle', 'welowe-themer'),
            'type'        => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
          'btn_title',
          [
            'label'       => __('Button Title', 'welowe-themer'),
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Learn More', 'welowe-themer'),
            'label_block' => true,
          ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
          'carousel_content',
          [
            'label'       => __('Content Item', 'welowe-themer'),
            'type'        => Controls_Manager::REPEATER,
            'fields'      => $repeater->get_controls(),
            'title_field' => '{{{ title }}}',
            'default'     => array(
               array(
                  'shadow_sub_title'  => esc_html__( 'Top Stories', 'welowe-themer' ),
                  'sub_title'         => esc_html__( 'Top Funding stories', 'welowe-themer' ),
