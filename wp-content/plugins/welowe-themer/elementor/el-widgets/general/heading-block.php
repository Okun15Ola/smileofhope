...
class GVAElement_Heading_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Heading Block', 'welowe-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'sub_title',
			[
				'label' => __( 'Sub Title', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your Sub Title', 'welowe-themer' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			'align',
			[
				'label' => __( 'Alignment Text', 'welowe-themer' ),
		...
		$this->add_control(
			'box_align',
			[
				'label' => __( 'Alignment Box', 'welowe-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'welowe-themer' ),
		...
		$this->add_responsive_control(
			'max_width',
			[
				'label' => __( 'Max Width (px)', 'welowe-themer' ),
		...
		$this->add_control(
			'auto_responsive',
			[
				'label' => __( 'Auto Responsive', 'welowe-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Auto Responsive size of title', 'welowe-themer' ),
				'default' => 'yes'
			]
		);
		...
		$this->start_controls_section( //** Section Icon
			'section_video',
			[
				'label' => __( 'Video Top', 'welowe-themer' ),
			]
		);
		$this->add_control(
			'video',
			[
				'label' 			=> __( 'Video', 'welowe-themer' ),
				'type' 			=> Controls_Manager::SWITCHER,
				'placeholder' 	=> __( 'Enable/Disable Video Heading', 'welowe-themer' ),
				'default' 		=> 'no'
			]
		);
		$this->add_control(
			'video_url',
			[
				'label' 			=> __( 'Video Youtube or Vimeo URL', 'welowe-themer' ),
				'label_block'	=> true,
				'type' 			=> Controls_Manager::TEXT,
				'condition' => [
					'video' => 'yes',
		...
		$this->start_controls_section( //** Section Button
			'section_button',
			[
				'label' => __( 'Button', 'welowe-themer' ),
			]
		);
		$this->add_control(
			'button_url',
			[
				'label' 	=> __( 'Button URL', 'welowe-themer' ),
		...
		$this->add_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'welowe-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' 					=> esc_html__('Button Size Default', 'welowe-themer'),
					'btn-size-small' 	=> esc_html__('Button Small', 'welowe-themer'),
					'btn-medium' 		=> esc_html__('Button Medium', 'welowe-themer')
				],
				'default' => '',
			]
		);
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Text Color', 'welowe-themer' ),
		...
		$this->add_control(
			'button_background',
			[
				'label' => __( 'Button Background', 'welowe-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color_hover',
			[
				'label' => __( 'Button Color Hover', 'welowe-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Background Hover', 'welowe-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_video_style',
			[
				'label' => __( 'Video Button', 'welowe-themer' ),
		...
		$this->add_control(
			'video_color',
			[
				'label' => __( 'Text Button Video Color', 'welowe-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'video_size',
			[
				'label' => __( 'Video Button Size', 'welowe-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 92,
				],
		...
		$this->add_responsive_control(
			'box_space',
			[
				'label' => __( 'Heading Element Space Bottom', 'welowe-themer' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'title_space',
			[
				'label' => __( 'Title Spacing', 'welowe-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sub Title Line Color', 'welowe-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'sub_title_space',
			[
				'label' => __( 'Sub Title Spacing', 'welowe-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 8,
				],
		...
		$this->add_responsive_control(
			'description_space',
			[
				'label' => __( 'Description Spacing', 'welowe-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px'],
				'default' => [
              'top'       => 20,
