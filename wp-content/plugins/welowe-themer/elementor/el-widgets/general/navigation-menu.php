...
class GVAElement_Navigation_Menu extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Navigation Menu', 'welowe-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> array(
					'style-default'	=> esc_html__('Default', 'welowe-themer'),
					'style-2'			=> esc_html__('Style II: Background, Flex', 'welowe-themer')
				),
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'welowe-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'label'	=> __('Mobile Menu settings', 'welowe-themer')
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Menu Mobile Breakpoint (px)', 'welowe-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' 		=> array(
					''								   => esc_html__('Default', 'welowe-themer'),
					'mobile-breakpoint-1400'	=> esc_html__('1400px', 'welowe-themer'),
					'mobile-breakpoint-1350'	=> esc_html__('1350px', 'welowe-themer'),
					'mobile-breakpoint-1300'	=> esc_html__('1300px', 'welowe-themer'),
					'mobile-breakpoint-1250'	=> esc_html__('1250px', 'welowe-themer'),
					'mobile-breakpoint-1200'	=> esc_html__('1200px', 'welowe-themer'),
					'mobile-breakpoint-1150'	=> esc_html__('1150px', 'welowe-themer'),
					'mobile-breakpoint-1100'	=> esc_html__('1100px', 'welowe-themer'),
					'mobile-breakpoint-1080'	=> esc_html__('1080px', 'welowe-themer'),
					'mobile-breakpoint-1024'	=> esc_html__('1024px', 'welowe-themer'),
					'mobile-breakpoint-992'		=> esc_html__('992px', 'welowe-themer'),
					'mobile-breakpoint-768'		=> esc_html__('768px', 'welowe-themer')
				),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'welowe-themer' ),
		...
		$this->add_responsive_control(
			'main_menu_padding',
			[
				'label' => __( 'Menu Item Padding', 'welowe-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'welowe-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __('Link Color', 'welowe-themer'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Mobile Icon', 'welowe-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
