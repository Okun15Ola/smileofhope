...
class GVAElement_Pricing_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Pricing Block', 'welowe-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style-1' 		=> __( 'Style I: Default', 'welowe-themer' )
				],
				'default' => 'style-1',
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => __( 'Basic Plan', 'welowe-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Save 45%', 'welowe-themer' ),
				'default' => __( 'Save 45%', 'welowe-themer' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Your Description', 'welowe-themer' ),
				'default' => __( 'Suitable For Any IT Solutions.', 'welowe-themer' ),
			]
		);
		$this->add_control(
			'price',
			[
				'label' => __( 'Price', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( '29.68', 'welowe-themer' ),
				'default' => __( '29.68', 'welowe-themer' ),
			]
		);
		$this->add_control(
			'currency',
			[
				'label' => __( 'Currency', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Currency', 'welowe-themer' ),
				'default' => __( '$', 'welowe-themer' ),
			]
		);
		$this->add_control(
			'period',
			[
				'label' => __( 'Period', 'welowe-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Monthly', 'welowe-themer' ),
				'default' => __( 'Monthly', 'welowe-themer' ),
			]
		);
      ...
      $repeater->add_control(
         'pricing_features',
			[
	         'label'       => __('Pricing Features', 'welowe-themer'),
	         'type'        => Controls_Manager::TEXT,
	   ...
	   $repeater->add_control(
		...
		$this->add_control(
         ...
         [
            ...
            'default'     => array(
               array(
                  'pricing_features'  => esc_html__( 'Resposive Design', 'welowe-themer' )
               ),
               array(
                  'pricing_features'  => esc_html__( 'Unlimited Entities', 'welowe-themer' )
               ),
               array(
                  'pricing_features'  => esc_html__( 'Premium Quality Support', 'welowe-themer' ),
                  'feature_active'	=> 'no'
               ),
               array(
                  'pricing_features'  => esc_html__( 'Hosted In The Cloud', 'welowe-themer' ),
                  'feature_active'	=> 'no'
               )
            ),
         ]
      ...
      $this->add_control(
			'pricing_active',
			[
	         'label'       => __('Pricing Active', 'welowe-themer'),
	         'type'        => Controls_Manager::SWITCHER,
	         'default'	  => 'no'
	     	]
		);
		...
		$this->start_controls_section(
			'section_price_style',
			[
				'label' => __( 'Price Text', 'welowe-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
