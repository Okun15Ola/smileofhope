...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('Testimonials', 'welowe-themer');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'welowe-themer'),
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1'  => esc_html__('Item Style 01', 'welowe-themer'),
                  'style-2'  => esc_html__('Item Style 02', 'welowe-themer'),
                  'style-3'  => esc_html__('Item Style 03', 'welowe-themer')
                ]
            )
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_WELOWE_PLUGIN_URL . 'elementor/assets/images/testimonial.jpg',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => array(
                    array(
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'welowe-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'welowe-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Kevin Smith', 'welowe-themer' ),
                        'testimonial_job'      => esc_html__( 'Crowd Company Founder', 'welowe-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Jessica Brown', 'welowe-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'welowe-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'David Anderson', 'welowe-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'welowe-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'welowe-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'welowe-themer' ),
                    ),
                ),
            ]
