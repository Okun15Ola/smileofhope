...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'welowe-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'welowe-themer' ),
		...
		$this->add_control(
			'event_display',
			[
				'label'   => __( 'Event Display', 'welowe-themer' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'All', 'welowe-themer' ),
					'upcoming'  => __( 'Upcoming', 'welowe-themer' )
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'event-1'     => __( 'Event Item Style I', 'welowe-themer' ),
					'event-2'     => __( 'Event Item Style II', 'welowe-themer' )
				],
				'default' => 'event-1',
				'condition' => [
	...
	public static function get_query_args(  $settings ) {
		...
		if($settings['event_display']){
			$query_args['eventDisplay'] = $settings['event_display'];
		}
