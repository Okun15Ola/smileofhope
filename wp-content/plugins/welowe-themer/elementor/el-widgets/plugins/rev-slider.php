...
class GVAElement_Rev_Slider extends \Elementor\Widget_Shortcode{
    ...
    public function get_title() {
        return __('GVA Revolution Slider', 'welowe-themer');
    }
    ...
    protected function register_controls() {
        ...
        if ( $arrSliders ) {
            ...
            $revsliders[ __( 'No sliders found', 'welowe-themer' ) ] = 0;
        }
        ...
        $this->add_control(
            'alias_slider',
            [
                'label'   => __( 'Choose Slider:', 'welowe-themer' ),
    ...
    protected function render() {
      ...
      printf( '<div class="gva-element-%s gva-element">', $this->get_name() );
        include(GAVIAS_WELOWE_PLUGIN_DIR . 'elementor/views/plugins/rev-slider.php');
      print '</div>';
