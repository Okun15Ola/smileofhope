...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'welowe-themer');
	 }
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'welowe-themer'),
						  'grid'          => __('Grid', 'welowe-themer'),
						  'carousel'      => __('Carousel', 'welowe-themer'),
						  'small_list'    => __('Small List', 'welowe-themer'),
						  'sticky'        => __('Post Large & List', 'welowe-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  ...
						  'post-style-3'         => __('Item Post Style III', 'welowe-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'welowe-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'welowe-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'welowe-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'welowe-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'welowe-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Post Content', 'welowe-themer'),
					'tab'   => Controls_Manager::TAB_STYLE,
					'condition' => [
		  	...
		  	$this->add_responsive_control(
				'post_box_padding',
				[
					'label' => __('Padding Post Content', 'welowe-themer'),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
		  ...
		  $this->add_control(
				'post_box_background',
				[
					 'label' => __('Background Post Content', 'welowe-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Title', 'welowe-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title', 'welowe-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title Hover', 'welowe-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'welowe-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
