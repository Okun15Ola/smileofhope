...
class GVA_Elementor_Override{
   ...
   public function column_control($obj, $args){
      ...
      $obj->start_controls_section(
         'gva_column_control',
         array(
            'label' => esc_html__( 'Other Settings', 'welowe-themer' ),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Inner Width', 'welowe-themer'),
   ...
   public function after_row_end( $obj, $args ) {
      $obj->start_controls_section(
         'gva_section_row',
         array(
            'label' => esc_html__( 'Gavias Extra Settings Row for Header Builder', 'welowe-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'welowe-themer' ),
      ...
      $obj->add_control(
         '_gva_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'welowe-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'welowe-themer' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'welowe-themer' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'welowe-themer'),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'welowe-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'welowe-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'welowe-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'Gavias Style Settings', 'welowe-themer' ),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __( 'Style Available', 'welowe-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''                 => __( '-- None --', 'welowe-themer' ),
            ],
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'welowe-themer' ),
               'theme'         => __( 'Background Color Theme', 'welowe-themer' ),
               'theme-second'  => __( 'Background Color Theme Second', 'welowe-themer' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
