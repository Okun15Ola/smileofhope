<?php
   ...
   $post_title = $welowe_post->post_title;
   $post_permalink = get_permalink($post_id);
?>

<div class="welowe-post-share <?php echo $settings['style'] ?>">
   
   <?php if($style == 'style-2'){ ?>
      <div class="share-button">
         <a href="#" class="btn-control-share btn-gray-icon">
            <i class="fas fa-share"></i><?php echo esc_html__('Share', 'welowe-themer') ?>
         </a>
      </div>
   ...
   <?php } ?>
      ...
      <ul class="social-networks-post clearfix">  
         <li class="title-share"><?php echo esc_html__( "Share This Post: ", "welowe-themer" ) ?></li>
         <li class="facebook">
