   ...
   <div class="feature-one__single<?php echo esc_attr($classes) ?>">
      <div class="feature-one__wrapper">
         ...
         <div class="feature-one__image">
            <?php 
               ...
               if(!empty($settings['title_text'])){
                  echo '<' . esc_attr($header_tag) . ' class="feature-one__title feature-one__title-first"><span>';
                     echo $title_html;
                  echo '</span></' . esc_attr($header_tag) . '>';
               } 
            ?>
         </div>
         ...
         <div class="feature-one__content">
            <?php 
               if ( $has_icon ){ 
                  echo '<div class="feature-one__icon">';
                     Icons_Manager::render_icon( $settings['selected_icon'], [ 'aria-hidden' => 'true' ] );
                  echo '</div>';
               } 
               if(!empty($settings['title_text'])){
                  echo '<' . esc_attr($header_tag) . ' class="feature-one__title"><span>';
                     echo $title_html;
                  echo '</span></' . esc_attr($header_tag) . '>';
               } 
            ...
            <?php if($settings['button_url']['url']){ ?>
               <div class="feature-one__action">
                  <?php echo $this->gva_render_link_html($settings['button_text'], $settings['button_url'], 'btn-border-white' ) ?>
               </div>
            <?php } ?>
         </div>
         ...
         echo '<div class="feature-two__wrapper">';
            if ($has_icon){ 
               echo '<div class="feature-two__icon">';
                  Icons_Manager::render_icon( $settings['selected_icon'], [ 'aria-hidden' => 'true' ] );
                  if($settings['number']){
                     echo '<span class="feature-two__number '.$settings['number_position'] . '">' . $settings['number'] . '</span>';
                  }
               echo '</div>';
            } 
