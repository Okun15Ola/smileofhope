	...
	<div class="gva-content-items"> 
					...
					//global $post;
					 while (have_posts()){ 
						...
						echo '<div class="item-columns item-masory">';
							$this->welowe_get_template_part('templates/content/item', $settings['style'], array(
		...
		<?php }else{ ?>
			<div class="search-no-results-content">
				<div class="message"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'welowe-themer' ); ?></div>
				<?php get_search_form() ?>
			</div>
		<?php } ?>   
	</div>
