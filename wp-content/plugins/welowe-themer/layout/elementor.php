      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'welowe_header_position',
               [
                  'label'     => esc_html__('Header Position', 'welowe-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'welowe-themer'),
                     'absolute'  => esc_html__('Absolute', 'welowe-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'welowe-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'welowe_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'welowe-themer'),
                  'type'      => Controls_Manager::SELECT,
