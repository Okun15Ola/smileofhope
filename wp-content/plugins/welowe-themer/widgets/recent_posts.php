...
class Welowe_Themer_Widget_Recent_Posts extends WP_Widget {
   ...
   */
   ...
   public function widget( $args, $instance ) {
      ...
      $default_title = esc_html__( 'Recent Posts', 'welowe-themer' );
            ...
            <li>
               <div class="clearfix post-list-item <?php echo (has_post_thumbnail($recent_post->ID) ? 'has-thumbnail' : 'no-thumbnail' )  ?>">
                  ...
                  <div class="post-content">
                     <?php
                        $comments_number = get_comments_number_text( esc_html__('0 Comments', 'welowe-themer'), esc_html__('1 Comment', 'welowe-themer'), esc_html__('% Comments', 'welowe-themer'), $recent_post->ID);
                        printf( 
...
function welowe_themer_widget_recent_posts(){
   return register_widget('Welowe_Themer_Widget_Recent_Posts');
}

add_action('widgets_init', 'welowe_themer_widget_recent_posts');
