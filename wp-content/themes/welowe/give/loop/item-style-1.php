<?php
  ...
  if($goal == 'unlimited'){
		$progress = 100;
		$progress_label = $togo = esc_html__("Unlimited", 'welowe');
  }else{
			...
			<?php if($goal == 'unlimited'){ ?>
				<div class="give-one__information unlimited">
					<div class="give-one__raised"> 
					  <span class="give-one__info-label"><?php echo esc_html__('Raised', 'welowe') ?></span> 
					  <span class="give-one__info-value"><?php echo esc_html($income) ?></span>
					</div>
					<div class="give-one__goal"> 
					  <span class="give-one__info-label"><?php echo esc_html__('Goal', 'welowe') ?></span> 
		  ...
		  <?php } ?>  
			...
			<div class="give-one__button">
				<a class="btn-inline text-theme" href="<?php esc_url(the_permalink()) ?>">
					<?php echo esc_html__('Donate Now', 'welowe') ?>
				</a>
			</div>
		</div>
</div>
