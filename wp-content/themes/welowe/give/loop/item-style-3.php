		...
		<div class="give-three__content">
			...
			<div class="give-three__raised">
	         <div class="give-three__total-raised">
	            <span class="give-three__raised-label"><?php echo esc_html__('Raised: ', 'welowe') ?></span>
	      ...
	      <div class="give-three__goal">
	         <span class="give-three__goal-label"><?php echo esc_html__('Goal:', 'welowe'); ?></span>
