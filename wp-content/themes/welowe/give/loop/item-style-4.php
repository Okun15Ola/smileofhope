...
<div class="give-four__single">
   <div class="give-four__image">
      ...
      <a href="<?php echo get_permalink(); ?>" class="give-four__overlay"></a>

   </div>

   <div class="give-four__content"> 
      <div class="give-four__content-inner"> 
         <h2 class="give-four__title"><a href="<?php esc_url(the_permalink()) ?>"><?php the_title() ?></a></h2>
         <?php 
            $progress_class = $progress < 10 ? 'percent-small' : 'percent-default';
            $progress_class .= ($progress == 0 ? ' percent-0' : '');
         ?>
         <div class="give-four__raised">
            <div class="give-four__total_raised">
               <span class="give-four__raised-value"><?php echo esc_html($income); ?></span>
               <span class="give-four__raised-label"><?php echo esc_html__('raised of ', 'welowe') ?></span>
               <span class="give-four__goal"><?php echo esc_html($goal); ?></span>
            </div>
            <div class="give-four__percent-raised"><?php echo esc_html($progress_label); ?></div>
         </div>
         <div class="give-four__progress">
            <div class="progress">
         ...
         <div class="give-four__button">
            <a class="btn-white" href="<?php esc_url(the_permalink()) ?>">
               <?php echo esc_html__('Donation Details', 'welowe') ?>
            </a>
         </div>
      </div>
   </div>   
