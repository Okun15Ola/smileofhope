...
<div class="container">	
	<div class="template-posts-archive row mt-80 mb-80">
		  	...
		  	<?php 
		  		if(have_posts()){
					...
					echo '<div class="pagination">';
						 echo welowe_pagination();
					echo '</div>';
			 	}else{
				 	echo '<div class="search-no-results-content">';
			  			echo '<div class="message">';
			  				echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'welowe' );
			  			echo '</div>';
			  		echo '</div>';
		  		 	get_search_form();
			 	}
