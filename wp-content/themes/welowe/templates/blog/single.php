...
<?php 
	...
	if(!isset($excerpt_words)){
		$excerpt_words = welowe_get_option('blog_excerpt_limit', 20);
	}
...
<div class="single-post-template">
	...
	<div class="single-content-inner pt-50 pb-50">
		<div class="container">
			<div class="row">
								...
								<div class="content-inner">
									...
									<?php 
										echo '<div class="post-content clearfix">';
											the_content( sprintf(
												esc_html__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'welowe' ),
												the_title( '<span class="screen-reader-text">', '</span>', false )
											) );

											wp_link_pages( array(
												'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'welowe' ) . '</span>',
												'after'       => '</div>',
												'link_before' => '<span>',
												'link_after'  => '</span>',
											) );
									...
									<?php the_tags( '<footer class="entry-meta-footer"><span class="tag-links"><span class="tag-title">' . esc_html__( 'Tags:', 'welowe' ) . '</span>', '', '</span></footer>' ); ?>
