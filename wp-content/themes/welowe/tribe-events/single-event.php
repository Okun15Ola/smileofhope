				...
				<div id="wp-content" class="wp-content clearfix">
					...
					<div id="tribe-events-content" class="tribe-events-single">
							...
							<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-xs-12">
								<div class="event-single-left">
									<div class="tribe-events-back">
										<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'All %s', '%s Events plural label', 'welowe' ), $events_label_plural ); ?></a>
									</div>
						...
						<div id="tribe-events-footer">
							<!-- Navigation -->
							<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'welowe' ), $events_label_singular ); ?>">
