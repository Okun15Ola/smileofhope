 ...
 */
   ...
   $columns_lg = welowe_get_option('product_columns_lg', $std_lg);
   $columns_md = welowe_get_option('product_columns_md', $std_md);
   $columns_sm = welowe_get_option('product_columns_sm', $std_sm);
   $columns_xs = welowe_get_option('product_columns_xs', $std_xs);
?>
